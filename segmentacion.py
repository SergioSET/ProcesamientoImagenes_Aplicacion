...
class GUI(customtkinter.CTk):
    ...
    def setup_sidebar(self):
        ...
        self.umbralizacion_label = customtkinter.CTkLabel(
            self.sidebar_frame,
            text="Segmentación",
            font=customtkinter.CTkFont(size=20, weight="bold"),
        )
        self.umbralizacion_label.grid(row=4, column=0, padx=20, pady=(20, 10))
        self.umbralizacion_select = customtkinter.CTkOptionMenu(
            self.sidebar_frame,
            state="disabled",
            values=[
                "No seleccionado",
    ...
    def update_image(self):
        ...
        self.ax.set_ylim(slice_data.shape[0], 0)
    ...
    def umbralizacion(self):
        ...
        self.tau_slider = customtkinter.CTkSlider(
            self.threshold_frame,
            from_=1,
            to=300,
            number_of_steps=299,
        ...
        self.umbralizar_button = customtkinter.CTkButton(
            self.threshold_frame, text="Umbralizar", command=umbralizar2
        )
    ...
    def isodata(self):
        ...
        self.isodata_button = customtkinter.CTkButton(
            self.threshold_frame, text="Isodata", command=isodata
        )
    ...
    def kmeans(self):
        ...
        self.cluster_label = customtkinter.CTkLabel(
            self.threshold_frame, text="Número de clusters: 2", anchor="w"
        )
        self.cluster_label.grid(row=1, column=0, padx=20, pady=(10, 0))

        self.cluster_input = customtkinter.CTkSlider(
            self.threshold_frame,
            from_=2,
            to=10,
            number_of_steps=8,
