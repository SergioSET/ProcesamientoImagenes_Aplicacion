...
class GUI(customtkinter.CTk):
    ...
    def create_widgets(self):
        self.button1 = customtkinter.CTkButton(self, text="Segmentación", command=self.select_option1)
        self.button1.grid(row=0, column=0, padx=10, pady=10, sticky="nsew")

        self.button2 = customtkinter.CTkButton(self, text="Procesamiento", command=self.select_option2)
